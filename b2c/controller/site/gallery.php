    ...
    public function diff(){
        ...
        if($goodsData){
            foreach($goodsData as $key=>$goods_row){
                ...
                $goodsBasicInfo[$key]['is_rx'] = $goods_row['prescription'];
                ...
                $products = $productModel->getList('bn,weight,price,product_id,spec_info,store,freez',array('goods_id'=>$goods_row['goods_id']));
                ...
                //$goodsBasicInfo[$key]['bn'] = $products[0]['bn'];
                /**** end 商品评分 ****/
            }
