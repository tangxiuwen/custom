 ...
 */
final class wap_payment_plugin_mbfb extends ectools_payment_app implements ectools_interface_payment_app
{
    ...
    public function __construct($app)
    {
        ...
        $this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mbfb', 'callback');
        ...
        //统一收银台接口地址
        $this->submit_url = 'https://www.baifubao.com/api/0/pay/0/wapdirect';
    ...
    {
        return app::get('ectools')->_('手机百付宝是百度旗下百度钱包推出的手机支付方式。');
    }
    ...
    public function callback(&$recv)
    {
        ...
        if ($this->is_return_vaild($recv, $mer_key)) {
            ...
            $ret['account'] = $mer_id;
            $ret['bank'] = app::get('ectools')->_('百度钱包手机支付');
