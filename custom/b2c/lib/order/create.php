...
class b2c_order_create extends b2c_api_rpc_request
{
    ...
    private function _chgdata(&$sdf, &$order_data, $member_indent='', &$msg='',$aCart=array())
    {
        ...
        /** 红包使用信息 **/
        $sdf_order['use_redpacket'] = $sdf['use_redpacket'];
        $sdf_order['share_id'] = $sdf['share_id'];
        $sdf_order['draw_id'] = $sdf['draw_id'];
        $sdf_order['redpacket_money'] = $sdf['redpacket_money'];
		// 订单创建过程添加项埋点
        ...
        $order_data['redpacket_pay'] = $order_detail['redpacket_pay'];
        $order_data['share_id'] = $order_detail['share_id'];
