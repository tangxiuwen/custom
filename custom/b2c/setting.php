...
'system.goods.prescription' => array('type' => SET_T_STR, 'default' => null, 'desc' => app::get('b2c')->_('处方药提示语')),

'system.order.cancel' => array('type' => SET_T_STR, 'default' => null, 'desc' => app::get('b2c')->_('订单自动取消时间'), 'helpinfo' => '<span class=\'notice-inline\'>' . app::get('b2c')->_('单位:小时') . '</span>'),
